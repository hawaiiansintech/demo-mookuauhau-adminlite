...
{:else if $isSignedIn === false}
	<div>
		please log in to upload files. The files need to be tied to a logged in user (unless you load
		using gedcomloader in <a href="https://github.com/hawaiiansintech/mookuauhau-backend"
			>hawaiiansintech/mookuauhau-backend</a
		>).
	</div>
{:else}
